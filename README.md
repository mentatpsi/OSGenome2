...
## Example
![Example of App](https://github.com/mentatpsi/OSGenome2/blob/main/screenshots/OSGenome05-06.png)
...
- Categories were generated by Claude (Anthropic) using gene and evidence data to produce standardized clinical tags (always confirm). 
